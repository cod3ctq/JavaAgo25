...
//        bas.setDireccion("Avenida Flores");
//        bas.setIdCajero(5873);
//        bas.setDatabase(cuentas);
//        bas.consultarSaldo();
//
//        Ticket t = bas.retirar("1928374655", "5555", 100);
//        System.out.println(t);
//        bas.consultarSaldo();

        Practicaja pc = new Practicaja();
        pc.setDireccion("Boulevard Hidalgo");
        pc.setIdCajero(5948);
        pc.setDatabase(cuentas);

        Ticket ticket = pc.depositar("1827364555", 13000);
