        ...
        if (cuenta != null) {
                ...
                if (monto <= this.LIMITE_DEPOSITO) {
                    ...
                    if (monto <= cuenta.getMax()) {
                        ...
                        // 4 el saldo actual + monto < maximo permitido
                        if (cuenta.getSaldo() + monto <= cuenta.getMax()) {
                            ...
                            ticket = new Ticket(this.folioOperacion = this.folioOperacion + 1, getDireccion(),
                    ...
                    System.out.println("Monto excede el limite mensual permitido");
                }
